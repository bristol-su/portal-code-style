...
class Config extends \PhpCsFixer\Config
{
    ...
    public function __construct($name = 'Bristol SU')
    {
    ...
    private function initialise()
    {
        $this->setRules([
            ...
            // Class, trait and interface elements (const, method and properties) must be separated with one or none blank line.
